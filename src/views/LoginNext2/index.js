...
import { navigateToScreen,getListOfTab, setRootUser, setRoot } from '../../utils/navigator';
import scrollPersistTaps from '../../utils/scrollPersistTaps';
import { InputField, GradientButton } from '../../components'
import styles from './styles';
import FastImage from 'react-native-fast-image';
import { WHITE, VIOLET } from '../../themes/colors'
class LoginNext2 extends React.Component {
  static options() {
    return {
      ...DEFAULT_HEADER_SMALL,
      ...HIDDEN_BOTTOM_TABS,
      ...
      >
        <View style={{ flex: 1 }}>
          <Text style={styles.title}>
            {'> Now let me see your HealthKit data so I can verify steps are real'}
          </Text>
        </View>

        <GradientButton
          title={'Enable HealthKid'}
          style={styles.button}
          size={'long'}
...
export default connect(mapStateToProps, mapDispatchToProps)(LoginNext2);
